    ...
    <div className="bg-white dark:bg-slate-900 min-h-screen text-slate-800 dark:text-slate-100 font-sans">
      ...
      <div className="max-w-6xl mx-auto px-6 py-20">
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start">
                ...
                <strong>Lead Generation:</strong> Engaging potential customers through strategic social channels.
              </li>
              <li className="flex items-start">
                <span className="text-blue-500 mr-2">✔</span>
                <strong>Client Persuasion:</strong> Strengthening brand loyalty through high-touch communication.
              </li>
              <li className="flex items-start">
                <span className="text-blue-500 mr-2">✔</span>
                <strong>Digital Strategy:</strong> Planning promotional campaigns to boost product visibility.
              </li>
            </ul>
          </div>
        ...
        <section className="mb-32">
          ...
          <div className="flex overflow-x-auto pb-10 hide-scrollbar gap-6 snap-x">
            ...
            <div className="min-w-[300px] md:min-w-[400px] snap-center bg-slate-100 dark:bg-slate-800 rounded-3xl p-8 hover:bg-blue-600 hover:text-white transition-all duration-300">
              ...
              <p className="text-sm opacity-80">LAN/Wi-Fi setup, troubleshooting, and infrastructure management.</p>
            </div>
            ...
            <div className="min-w-[300px] md:min-w-[400px] snap-center bg-slate-100 dark:bg-slate-800 rounded-3xl p-8 hover:bg-blue-600 hover:text-white transition-all duration-300">
              ...
              <p className="text-sm opacity-80">SCCM, Intune, Group Policy, and Active Directory management.</p>
            </div>
            ...
            <div className="min-w-[300px] md:min-w-[400px] snap-center bg-slate-100 dark:bg-slate-800 rounded-3xl p-8 hover:bg-blue-600 hover:text-white transition-all duration-300">
              ...
              <p className="text-sm opacity-80">Full-stack solutions using React, Node.js, and Odoo ERP</p>
            </div>
        ...
        <section className="text-center py-20 bg-blue-600 rounded-3xl text-white">
          ...
          <p className="mb-8 opacity-90">Currently based in Doha, Qatar</p>
          <div className="flex flex-col md:flex-row justify-center gap-6 text-xl font-medium">
            <a href="mailto:akashadhikari0526@Gmail.com" className="underline decoration-2 underline-offset-4 hover:text-black transition">akashadhikari0526@Gmail.com</a>
            <span className="hidden md:block">|</span>
            <span>+974 33779585 </span>
          </div>
        </section>
